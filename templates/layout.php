...
<div class="page-wrapper">
    <header class="main-header">
        <div class="main-header__container container">
            ...
            <form class="main-header__search" method="get" action="page-search.php" autocomplete="off">
            ...
            <nav class="user-menu">
                ...
                <div class="user-menu__logged">
                    <p><?=$user_name ?></p>
                    <a class="user-menu__bets" href="page-mybets.php">Мои ставки</a>
                    <a class="user-menu__logout" href="page-logout.php">Выход</a>
                </div>
                <?php else: ?>
                    <ul class="user-menu__list">
                        <li class="user-menu__item">
                            <a href="page-signup.php">Регистрация</a>
                        </li>
                        <li class="user-menu__item">
                            <a href="page-login.php">Вход</a>
                        </li>
                    </ul>
                <?php endif; ?>
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" href="page-add.php">Добавить лот</a>
